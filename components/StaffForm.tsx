...
const StaffForm: React.FC<StaffFormProps> = ({ onClose, onSubmit, companyId }) => {
  ...
  const encryptCredential = async (credential: RESTCredential): Promise<RESTCredential> => {
    try {
      ...
      return encrypted as RESTCredential;
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label htmlFor="staffName" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Full Name</label>
            ...
            <div className="space-y-2">
              <label htmlFor="staffEmail" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Work Email</label>
              <div className="relative">
          ...
          <div className="space-y-2">
            <label htmlFor="staffRole" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Professional Job Title</label>
            <div className="relative">
          ...
          <div className="space-y-2">
            <label htmlFor="staffPhone" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Direct Contact Phone</label>
            <div className="relative">
                  ...
                  <div key={cred.id} className="bg-slate-50 border border-slate-200 rounded-2xl p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label htmlFor={`service-${cred.id}`} className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Service</label>
                        <select
                          id={`service-${cred.id}`}
                      ...
                      <div className="space-y-1">
                        <label htmlFor={`desc-${cred.id}`} className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Description</label>
                        <input
                          id={`desc-${cred.id}`}
                          type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label htmlFor={`apiKey-${cred.id}`} className="text-[8px] font-black text-slate-400 uppercase tracking-widest">API Key</label>
                        <input
                          id={`apiKey-${cred.id}`}
                          type="password"
                      ...
                      <div className="space-y-1">
                        <label htmlFor={`secretKey-${cred.id}`} className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Secret Key (Optional)</label>
                        <input
                          id={`secretKey-${cred.id}`}
                          type="password"
